...
public class ConfigureEventValidationTests
{
    static ConfigureEventValidationTests()
    {
    ...
    public void AddCompetition_WhenNameExistsIgnoringCaseAndWhitespace_Throws()
    {
        ...
        Assert.Equal(nameof(NTS.Domain.Setup.Aggregates.ConfigureEvents.Competition.Name), ex.Property);
    }
    ...
    public void AddLoop_WhenDistanceExists_Throws()
    {
        ...
        Assert.Equal(nameof(NTS.Domain.Setup.Aggregates.ConfigureEvents.Loop.Distance), ex.Property);
    }
    ...
    public void AddCombination_WhenNumberExists_Throws()
    {
        ...
        Assert.Equal(nameof(NTS.Domain.Setup.Aggregates.ConfigureEvents.Combination.Number), ex.Property);
    }
    ...
    public void AddCombination_WhenAthleteAlreadyAssigned_Throws()
    {
        ...
        Assert.Equal(nameof(NTS.Domain.Setup.Aggregates.ConfigureEvents.Combination.Athlete), ex.Property);
    }
    ...
    public void UpdateCombination_WhenHorseAlreadyAssigned_Throws()
    {
        ...
        Assert.Equal(nameof(NTS.Domain.Setup.Aggregates.ConfigureEvents.Combination.Horse), ex.Property);
    }
    ...
    static NTS.Domain.Setup.Aggregates.ConfigureEvents.Competition CreateCompetition(int id, string name)
    {
        return new NTS.Domain.Setup.Aggregates.ConfigureEvents.Competition(
            name: name,
    ...
    static NTS.Domain.Setup.Aggregates.ConfigureEvents.Loop CreateLoop(int id, double distance)
    {
        return new NTS.Domain.Setup.Aggregates.ConfigureEvents.Loop(distance, id);
    }

    static NTS.Domain.Setup.Aggregates.ConfigureEvents.Combination CreateCombination(
        int id,
        int number,
        Athlete athlete,
        Horse horse
    ...
    {
        return new NTS.Domain.Setup.Aggregates.ConfigureEvents.Combination(number, athlete, horse, id);
    }
