...
namespace NTS.Localization
{
    public static class NtsStrings
    {
        ...
        public static string Download_results_string => LocalizeString(nameof(Download_results_string));
        ...
        public static string Action_string => LocalizeString(nameof(Action_string));
