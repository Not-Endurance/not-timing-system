...
namespace NTS.Localization
{
    public static class NtsStrings // TODO: csharpierignore this file
    {
        ...
        public static string Rider_string =>
            LocalizeString(nameof(Rider_string));
        public static string Club_string =>
            LocalizeString(nameof(Clubs_string));

        public static string Average_speed =>
            LocalizeString(nameof(Average_speed));
        public static string Eliminated_string =>
            LocalizeString(nameof(Eliminated_string));
        public static string Eliminated_with_colon_string =>
            LocalizeString(nameof(Eliminated_with_colon_string));
        public static string Competition_ongoing_string =>
            LocalizeString(nameof(Competition_ongoing_string));
    }
}
