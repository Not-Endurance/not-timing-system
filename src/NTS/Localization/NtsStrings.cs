...
namespace NTS.Localization
{
    public static class NtsStrings
    {
        ...
        public static string Are_handouts_printed_successfully_Yes_will_delete_all_handouts_This_cannot_be_undone_string =>
            LocalizeString(
                nameof(Are_handouts_printed_successfully_Yes_will_delete_all_handouts_This_cannot_be_undone_string)
            );
        ...
        public static string Witnesses_connected__colon_string =>
        ...
        public static string Custom_ranking_string => LocalizeString(nameof(Custom_ranking_string));
        ...
        public static string Locate_FEI_Show_data_instructions_string => LocalizeString(nameof(Locate_FEI_Show_data_instructions_string));
        public static string FEI_Event_Code_helper_text_string => LocalizeString(nameof(FEI_Event_Code_helper_text_string));
        public static string FEI_Competition_ID_helper_text_string => LocalizeString(nameof(FEI_Competition_ID_helper_text_string));
        public static string FEI_Rule_helper_text_string => LocalizeString(nameof(FEI_Rule_helper_text_string));
        public static string FEI_Schedule_Number_helper_text_string => LocalizeString(nameof(FEI_Schedule_Number_helper_text_string));
        ...
        public static string Phase_T_string => LocalizeString(nameof(Phase_T_string));
        ...
        public static string Configure_Combination_string => LocalizeString(nameof(Configure_Combination_string));
        public static string Configure_Clubs_string => LocalizeString(nameof(Configure_Clubs_string));
        public static string Eliminate_string => LocalizeString(nameof(Eliminate_string));
        ...
        public static string Event_is_not_started_yet_string => LocalizeString(nameof(Event_is_not_started_yet_string));
        public static string File_uploaded_successfully_string =>
