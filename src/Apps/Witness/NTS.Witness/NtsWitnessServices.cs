...
{
    public static IServiceCollection AddNtsWitness(this IServiceCollection services, IConfiguration configuration, string baseUrl)
    {
        services
        ...
        services.AddHttpClient(nameof(NHttpClient), client =>
        {
