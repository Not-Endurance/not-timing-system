...
public class SnapshotResultFunctions : CrudFunctions<SnapshotResultModel>
{
    public SnapshotResultFunctions(
        IFunctionLogger<SnapshotResultFunctions> logger,
        IMongoRepository<SnapshotResultModel> snapshotResults,
    ...
    public async Task<IActionResult> Create(
        [HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "snapshot-results")] HttpRequest request
    )
    {
    ...
    public async Task<IActionResult> Update(
        [HttpTrigger(AuthorizationLevel.Anonymous, "patch", Route = "snapshot-results")] HttpRequest request
    )
    {
