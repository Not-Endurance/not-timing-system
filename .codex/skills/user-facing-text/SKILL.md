...
- Localize through the standard `NStrings` / `NtsStrings` property approach.
...
- If a localized value contains a parameter, include the parameter index in the property name as `_<x>_`, where `x` is the parameter index.
